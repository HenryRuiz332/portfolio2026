      ...
      <div class="row d-flex">
        <div class="col-md-6 col-lg-5 d-flex">
          <div class="img-about img d-flex align-items-stretch">
            ...
            <div class="img d-flex align-self-stretch align-items-center" :style="{ backgroundImage: `url(${bgAbout})` }">
            </div>
          </div>
        </div>
          ...
          <div class="row justify-content-start pb-3">
            <div class="col-md-12 heading-section" data-aos="fade-up" data-aos-duration="1000">
              ...
              <ul class="about-info mt-4 px-md-0 px-2">
                <li class="d-flex"><span>Name:</span> <span>Henry Ruiz</span></li>
                ...
                <li class="d-flex"><span>Email:</span> <span>henryruiz@gmail.com</span></li>
                <li class="d-flex"><span>Phone: </span> <span>+1-2234-5678-9-0</span></li>
              </ul>
            </div>
          </div>
          <div class="counter-wrap d-flex mt-md-3" data-aos="fade-up" data-aos-duration="1000">
            <div class="text">
              <p class="mb-4">
